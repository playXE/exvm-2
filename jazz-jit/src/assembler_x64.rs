...
#[no_mangle]
pub extern "C" fn fits_i32(n: i64) -> bool {
    n == (n as i32) as i64
}
...
impl Assembler {
    ...
    pub extern "C" fn jump(&mut self, lbl: Label) {
        buf::emit_jmp(self, lbl);
    }

    pub extern "C" fn jump_reg(&mut self, reg: Register) {
    ...
    pub extern "C" fn int_sal(
        ...
        buf::emit_sal_reg_cl(self, x64, lhs);
...
pub extern "C" fn xchg(buf: &mut Assembler, x64: u8, src: Register, dest: Register) {
    emit_alu_reg_reg(buf, x64, 0x87, src, dest);
}
...
#[no_mangle]
pub extern "C" fn emit_movb_memq_reg(
    buf: &mut Assembler,
    src: Register,
    disp: i32,
    dest: Register,
...
#[no_mangle]
pub extern "C" fn emit_movl_memq_reg(
    buf: &mut Assembler,
    src: Register,
    disp: i32,
    dest: Register,
...
#[no_mangle]
pub extern "C" fn emit_movzbl_memq_reg(
    buf: &mut Assembler,
    src: Register,
    disp: i32,
    dest: Register,
...
#[no_mangle]
pub extern "C" fn emit_movq_memq_reg(
    buf: &mut Assembler,
    src: Register,
    disp: i32,
    dest: Register,
...
#[no_mangle]
pub extern "C" fn emit_movq_reg_memq(
    buf: &mut Assembler,
    src: Register,
    dest: Register,
    disp: i32,
...
#[no_mangle]
pub extern "C" fn emit_movl_reg_memq(
    buf: &mut Assembler,
    src: Register,
    dest: Register,
    disp: i32,
...
#[no_mangle]
pub extern "C" fn emit_movb_reg_memq(
    buf: &mut Assembler,
    src: Register,
    dest: Register,
    disp: i32,
...
#[no_mangle]
pub extern "C" fn emit_movb_imm_memscaleq(
    buf: &mut Assembler,
    imm: u8,
    base: Register,
    index: Register,
...
#[no_mangle]
pub extern "C" fn emit_cmp_imm_reg(
    buf: &mut Assembler,
    mode: MachineMode,
    imm: i32,
    reg: Register,
...
#[no_mangle]
pub extern "C" fn cpuid(buf: &mut Assembler) {
    emit_op(buf, 0x0f);
    emit_op(buf, 0xa2);
}
#[no_mangle]
...
#[no_mangle]
pub extern "C" fn emit_sub_imm_mem(
    buf: &mut Assembler,
    mode: MachineMode,
    base: Register,
    imm: u8,
...
#[no_mangle]
pub extern "C" fn emit_retq(buf: &mut Assembler) {
    emit_op(buf, 0xC3);
}
pub extern "C" fn emit_retq_imm(buf: &mut Assembler, imm: u16) {
    if imm == 0 {
        emit_retq(buf);
    } else {
        emit_op(buf, 0xC2);
...
#[no_mangle]
pub extern "C" fn emit_nop(buf: &mut Assembler) {
    emit_op(buf, 0x90);
}
#[no_mangle]
pub extern "C" fn emit64(buf: &mut Assembler, val: u64) {
    buf.emit64(val)
}
#[no_mangle]
pub extern "C" fn emit32(buf: &mut Assembler, val: u32) {
    buf.emit32(val)
}
#[no_mangle]
pub extern "C" fn emit(buf: &mut Assembler, val: u8) {
    buf.emit(val)
}
#[no_mangle]
pub extern "C" fn emit_op(buf: &mut Assembler, opcode: u8) {
    buf.emit(opcode);
}
#[no_mangle]
...
#[no_mangle]
pub extern "C" fn fits_i8(imm: i32) -> bool {
...
#[no_mangle]
pub extern "C" fn emit_cmp_mem_reg(
    buf: &mut Assembler,
    mode: MachineMode,
    base: Register,
    disp: i32,
...
#[no_mangle]
pub extern "C" fn emit_mov_memindex_reg(
    buf: &mut Assembler,
    mode: MachineMode,
    base: Register,
    index: Register,
...
#[no_mangle]
pub extern "C" fn emit_movzx_memindex_byte_reg(
    buf: &mut Assembler,
    x64: u8,
    base: Register,
    index: Register,
...
#[no_mangle]
pub extern "C" fn emit_mov_reg_memindex(
    buf: &mut Assembler,
    mode: MachineMode,
    src: Register,
    base: Register,
...
#[no_mangle]
pub extern "C" fn emit_cmp_mem_imm(
    buf: &mut Assembler,
    mode: MachineMode,
    base: Register,
    disp: i32,
...
#[no_mangle]
pub extern "C" fn emit_cmp_memindex_reg(
    buf: &mut Assembler,
    mode: MachineMode,
    base: Register,
    index: Register,
...
#[no_mangle]
pub extern "C" fn emit_cdq(buf: &mut Assembler) {
    emit_op(buf, 0x99);
}
#[no_mangle]
...
pub extern "C" fn emit_sal_reg_cl(buf: &mut Assembler, x64: u8, dest: Register) {
    if dest.msb() != 0 || x64 != 0 {
        emit_rex(buf, x64, 0, 0, dest.msb());
    }
    emit_op(buf, 0xD3);
    emit_modrm(buf, 0b11, 0x04, dest.and7());
}
...
#[no_mangle]
pub extern "C" fn sse_packed_freg_freg(
    buf: &mut Assembler,
    op: u8,
    dest: XMMRegister,
    src: XMMRegister,
...
#[no_mangle]
pub extern "C" fn sse_float_freg_freg(
    buf: &mut Assembler,
    dbl: bool,
    op: u8,
    dest: XMMRegister,
...
#[no_mangle]
pub extern "C" fn sse_float_freg_mem(
    buf: &mut Assembler,
    dbl: bool,
    op: u8,
    dest: XMMRegister,
...
#[no_mangle]
pub extern "C" fn sse_float_freg_mem_66(
    buf: &mut Assembler,
    dbl: bool,
    op: u8,
    dest: XMMRegister,
...
#[no_mangle]
pub extern "C" fn sse_float_freg_reg(
    buf: &mut Assembler,
    dbl: bool,
    op: u8,
    dest: XMMRegister,
...
#[no_mangle]
pub extern "C" fn sse_float_reg_freg(
    buf: &mut Assembler,
    dbl: bool,
    op: u8,
    x64: u8,
...
#[no_mangle]
pub extern "C" fn vpunpcklbw_mem(
    buf: &mut Assembler,
    dst: XMMRegister,
    src1: XMMRegister,
    src2: Mem,
...
#[no_mangle]
pub extern "C" fn vpunpcklwd_mem(
    buf: &mut Assembler,
    dst: XMMRegister,
    src1: XMMRegister,
    src2: Mem,
...
#[no_mangle]
pub extern "C" fn vpunpckldq_mem(
    buf: &mut Assembler,
    dst: XMMRegister,
    src1: XMMRegister,
    src2: Mem,
...
#[no_mangle]
pub extern "C" fn vpunpckhbw_mem(
    buf: &mut Assembler,
    dst: XMMRegister,
    src1: XMMRegister,
    src2: Mem,
...
#[no_mangle]
pub extern "C" fn vpunpckhwd_mem(
    buf: &mut Assembler,
    dst: XMMRegister,
    src1: XMMRegister,
    src2: Mem,
...
#[no_mangle]
pub extern "C" fn vpunpckhdq_mem(
    buf: &mut Assembler,
    dst: XMMRegister,
    src1: XMMRegister,
    src2: Mem,
...
#[no_mangle]
pub extern "C" fn vpunpcklqdq_mem(
    buf: &mut Assembler,
    dst: XMMRegister,
    src1: XMMRegister,
    src2: Mem,
...
#[no_mangle]
pub extern "C" fn vpunpckhqdq_mem(
    buf: &mut Assembler,
    dst: XMMRegister,
    src1: XMMRegister,
    src2: Mem,
